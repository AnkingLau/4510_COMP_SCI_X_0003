 ...
 */
 ...
 // Handle message from layer 5 at sender
 void A_output(struct msg message) {
     if ((nextseqnum + SEQSPACE - base) % SEQSPACE < WINDOWSIZE) {
         ...
         for (i = 0; i < 20; i++) packet.payload[i] = message.data[i];
